  ...
  return (
    <div className="py-8 max-w-full text-gray-700">
      ...
      <section className="mb-16 px-3 md:px-8 py-8 shadow bg-white">
        ...
        <div className="flex flex-wrap md:flex-nowrap mt-8">
          <JsIcon />
          <strong className="px-1">main.js</strong> :
          <p className="pl-1">
            This<strong className="px-1 font-medium">Main</strong> component
            contains the content of the route/view
          </p>
        </div>
      </section>
        ...
        <div className="mt-8">
          <ul className="pl-6 list-disc mt-4">
            ...
            <li className="mb-3">
              ...
              <span className="px-1 font-medium">DashboardProvider</span>and
